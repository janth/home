...
" approx cfengine version: 201-207
"
" cfengine action
" action-type:
"   compound-class::
...
syn region  foldGroup  start="BeginGroup"  end="EndGroup.*$" contains=cfengineEditAction,cfengineString keepend transparent fold
syn region  foldBlock  start="{"           end="}"           contains=TOP fold
"syn region  foldAction start="(addmounts|checktimezone|copy|directories|disable|editfiles|files|links|mailcheck|module|mountall|mountinfo|netconfig|required|resolve|shellcommands|tidy|unmount|processes|packages):" end="}}" contains=TOP fold
"syn region  foldAction start="shellcommands:" end="§" fold
"syn region  cfengineBlock  start="{"           end="}"       contains=cfengineEditAction,cfengineString,cfengineVariable 
...
syn keyword cfengineKeyword    BindToInterface HostnameKeys SecureInput
syn case ignore
...
syn region  cfengineHelpers    matchgroup=cfengineKeyword start="Prepmodule(" end=")"        contained oneline
syn region  cfengineHelpers    matchgroup=cfengineKeyword start="Regcmp(" end=")"        contained oneline
syn region  cfengineHelpers    matchgroup=cfengineKeyword start="Strcmp(" end=")"        contained oneline
syn region  cfengineHelpers    matchgroup=cfengineKeyword start="IsDefined(" end=")"        contained oneline
syn region  cfengineHelpers    matchgroup=cfengineKeyword start="HostRange(" end=")"        contained oneline
...
syn keyword cfengineEditAction CommentLinesContaining CommentLinesMatching CommentLinesStarting CommentNLines CommentToLineMatching contained
...
syn keyword cfengineEditAction DeleteLinesContainingFileItems DeleteLinesMatchingFileItems DeleteLinesStartingFileItems contained
syn keyword cfengineEditAction DeleteLinesNotContainingFileItems DeleteLinesNotMatchingFileItems DeleteLinesNotStartingFileItems contained
syn keyword cfengineEditAction AppendIfNoSuchLinesFromFile contained
syn keyword cfengineEditAction DeleteLinesStarting DeleteNLines DeleteToLineMatching DeleteItemNotMatching DeleteItemNotStarting contained
...
if version >= 508 || !exists("did_cfengine_syn_inits")
  ...
  HiLink cfengineBlock              Special
  HiLink foldBlock              Special
  HiLink cfengineVariableDef        NONE
  HiLink cfengineBoolean            Boolean
  "HiLink cfengineEditAction         Special
  HiLink cfengineEditAction         Statement
